        ...
        <material-card color="orange" full-header>
          <template #heading>
            <div class="pa-8 white--text">
              <div class="text-h4 font-weight-light">Orders</div>
...
import Vue from "vue";
import MaterialCard from "./dashboard/MaterialCard.vue";
import MaterialChartCard from "./dashboard/MaterialChartCard.vue";
import MaterialStatCard from "./dashboard/MaterialStatsCard.vue";

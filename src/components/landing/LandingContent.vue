<template>
  <div>
    <FirstAd />
    <ProductSlide title="Deal of the day" :data="dealOfTheDay" />
    <SecondAd />
...
import FirstAd from "../advertisement/FirstAd";
import SecondAd from "../advertisement/SecondAd";
import ThirdAd from "../advertisement/ThirdAd";
export default {
  components: {
    CategoryCard,
    ProductSlide,

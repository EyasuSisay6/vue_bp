  ...
  <div>
    <div>
        ...
        <v-row no-gutters
          ><v-col sm="3">
            <v-row>
              ...
              <v-spacer></v-spacer>
              <v-icon class="hidden-md-and-down">mdi-weather-sunny</v-icon>
              <v-list-item-action class="hidden-md-and-down">
                <v-switch v-model="isDark" inset></v-switch>
              </v-list-item-action>
              <v-icon class="pl-2 hidden-md-and-down">mdi-weather-night</v-icon>
            </v-row>
          </v-col>
      ...
      <div class="appbarBorder">
        <v-app-bar flat height="50px" dark color="#09B750">
          <v-row no-gutters>
